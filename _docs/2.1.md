...
ORDER violations may also appear on the phrase-level, as in cases of phrasal derivation (e.g. **Example 4**, **Section 1.2**) and phrasal compounding<sup>[24](#fn24)</sup> where syntax appears to function as the input to word formation.  For example, Bruening (2018:4) provides the American English advertisement in **Example 14a**, in which a full VP functions as an adjectival modifier within the NP *<sup>NP</sup>[the <sup>VP</sup>[prevent-mold-on-your-shower-curtain-for-up-to-seven-days] <sup>N</sup>[spray]]*. Botha (1981:76), Tokizaki (2017:2), and Wiese (1996:185) provide similar examples in Afrikaans, Japanese, and Mandarin Chinese, respectively<sup>[25](#fn25)</sup>.  
...
<a name="fn24">24</a>: Phrasal compounding has been formally characterized by Meibauer (2007:234) as a word formation process “of the type YP+X, with YP modifying X semantically”, e.g. *[<sup>VP</sup>[prevent mold on your shower curtain …] + <sup>N</sup>[spray]]*.  
