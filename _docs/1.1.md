...
<a name="fn1"><sup>1</sup></a>: Aronoff (1976:5-6) observes earlier work in generative phonology likewise led to a reintroduction of morphology; specifically, Chomsky and Halle’s (1968) attempts to constrain the power of phonological theory revealed that various phenomena (e.g. rules of inflectional morphology) were beyond a formal phonological theory (i.e. part of morphology).
